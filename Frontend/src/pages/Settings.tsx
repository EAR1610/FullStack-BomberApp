            ...
            <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
              <div className="border-b border-stroke py-4 px-7 dark:border-strokedark">
                <h3 className="font-medium text-black dark:text-white">
                  Configuración general de BomberApp
                </h3>
              </div>
              <div className="p-7">
                <form action="#" onSubmit={ handleSubmit }>
                    ...
                    <div className="w-full sm:w-1/2">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          name="fullName"
                          id="fullName"
                          placeholder="Edixon R."
                          defaultValue="Edixon R."
                        />
                      </div>
                    </div>
                  ...
                  {/* <div className="mb-5.5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        name="emailAddress"
                        id="emailAddress"
                        placeholder="edixon@dev.com"
                        defaultValue="edixon@dev.com"
                      />
                    </div>
                  </div>
                  ...
                  <div className="mb-5.5">
                    <label
                      className="mb-3 block text-sm font-medium text-black dark:text-white"
                      htmlFor="penalizations"
                    >
                      Penalizaciónes máximas por usuario
                    </label>
                    <input
                      className="w-full rounded border border-stroke bg-gray py-3 px-4.5 text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
                      type="number"
                      ...
                      min={0}
                      id="penalizations"
                      value={settings?.maxPenalizations}
                      onChange={ e => setSettings({ ...settings, maxPenalizations: e.target.value }) }
                      placeholder="Ingrese la cantidad de penalizaciones máximas por usuario"
                    />
                  </div>
