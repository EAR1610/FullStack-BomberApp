        ...
        <div className='w-full border-stroke dark:border-strokedark'>
          <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
            <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2 text-center">
             Estas viendo la información del insumo <span className='text-red-500'>BomberApp</span>
            </h2>
            <form>
              <div className="mb-4">
              ...
              <div className="mb-4">
                <label htmlFor='supplyType' className="mb-2.5 block font-medium text-black dark:text-white">
                  Tipo de insumo
                </label>
                <div className="relative">
                  <input
