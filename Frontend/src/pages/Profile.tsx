  ...
  return (
    <div className="container mx-auto p-6">
      <div className="flex flex-col lg:flex-row gap-6">
        {/* Div para la información personal del cliente */}
        <div className="w-full lg:w-1/2 bg-white p-6 rounded-lg shadow-lg">
          {/* Aquí iría tu componente de información personal */}
          <h2 className="text-xl font-semibold mb-4">Información Personal</h2>
          {/* Componente de información personal del cliente */}
          ...
          <form onSubmit={handleChangePassword}>
            <div className="mb-4">
              ...
              <input
                id="currentPassword"
                type="password"
                className="w-full p-3 border rounded-lg text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-800"
